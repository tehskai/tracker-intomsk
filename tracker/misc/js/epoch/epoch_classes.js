...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function setLang() {
		...
		self.clearbtn_title = 'Очищает все даты выбранные в календаре';
		self.maxrange_caption = 'Дата за пределами диапазона';
		self.closebtn_caption = 'Спрячьте';
		self.closebtn_title = 'Закройте календар';
	}
	//-----------------------------------------------------------------------------
	/**
...
Date.prototype.dateFormat = function(format)
{
	...
	var DAY_NAMES = new Array('Воскресенье','Понедельник','Вторник','Среда','Четверг','Пятница','Суббота','Вос','Пон','Вто','Сре','Чет','Пят','Суб');
	var result="";
	var i_format=0;
	var c="";
	var token="";

...
define('TORHIT_TABLE',        'bb_torhit');
define("PHOTOS_TABLE",        'bb_photos');
...
class datastore_common
{
	...
	*/
	var $known_items = array(
		...
		'top_downloaded'         => 'build_cat_forums.php',
		'top_uploaders'          => 'build_cat_forums.php',
		'top_downloaders'        => 'build_cat_forums.php',

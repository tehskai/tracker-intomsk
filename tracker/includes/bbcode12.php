...
<object width="640" height="385">
    <param name="movie" value="http://www.youtube.com/v/\\1&hl=ru_RU&fs=1&"></param>
    <param name="allowFullScreen" value="true"></param>
    <param name="allowscriptaccess" value="always"></param>
    <embed src="http://www.youtube.com/v/\\1&hl=ru_RU&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="640" height="385" wmode="transparent"></embed>
</object>
HTML;
...
$bbcode_tpl['quote_open'] = <<<HTML
    ...
    <img class="lu" src="/templates/tracker/images/quotecode/openq.png" />
    <img class="rb" src="/templates/tracker/images/quotecode/closeq.png"/>
HTML;
...
$bbcode_tpl['mod'] = <<<HTML
<div>
<table id="bsh" width="90%" cellspacing="1" cellpadding="3" border="0" align="center">
<tr>
...
/*
$bbcode_tpl['thumbnails'] = <<<HTML
<a href="\\1" rel="lightbox1" class="highslide">
<img src="\\1" style="max-width:200px; max-height:120px;" class="thumb" />
</a>
HTML;
*/

...
define('ADMIN',        1);
define('MOD',          2);
define('RG_REALESERS', 6); //user_rank, not user_level!!!
define('S_G',          8); //user_rank, not user_level!!!
define('RG_GAMEMAN',   4); //user_rank, not user_level!!!
define('VIP',          5); //user_rank, not user_level!!!
define('EDIT_NVS',     9); //user_rank, not user_level!!!
...
define('BB_UNBANLIST',            'bb_unbanlist');
...
define('BB_BANNER_STATS', 'bb_banner_stats');
define('BB_BANNERS', 'bb_banner');
// End add - Complete banner MOD
define('BB_TORHITS',              'bb_torhits');

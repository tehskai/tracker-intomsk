...
class captcha_common
{
	...
	function get_html ()
	{
		...
		return '
			<div><img src="'. $this->new_img_url .'?'. mt_rand() .'" width="120" height="45" alt="pic" /></div>
			<input type="hidden" name="'. $this->cap_sid_key .'" value="'. $this->new_cap_sid .'" />
			<input type="text" class="username" name="'. $this->new_code_key .'" placeholder="Код с картинки" value="" size="25" class="bold" />
		';
	}

...
<span class="buttons">
	...
	<input type="button" value="Скриншоты" name="codeSkrinshot" title="Скриншоты" style="width: 90px;" />
	<input type="button" value="{L_SKETCH}" name="codeThumbnails" title="{L_SKETCH_TITLE}" style="width: 50px" />
	<input type="button" value="{L_BBCODE_YOUTUBE}" name="codeYouTube" title="{L_BBCODE_YOUTUBE_TITLE}" style="width: 70px;"/>
</span>
&nbsp;
...
<div class="buttons mrg_4">
	...
	<input type="button" value="Тень" name="codeSH" title="Тень" style="width: 40px;"/>
...
<!-- IF IS_AM --><input type="button" value="Предупреждение" name="codemod" style="width: 130px;"><!-- ENDIF -->
	<input type="button" value="{L_LIST}" name="codeList" title="{L_LIST_TITLE}"  style="width: 60px;"/>
	<input type="button" value="*" name="codeOpt" title="{L_LIST_ITEM}" style="width: 30px;" />&nbsp;
    ...
    <!-- IF USER_RUS -->
	<!--<input type="button" value="{L_TRANSLIT}" name="Translit" title="{L_TRANSLIT_TITLE}" style="width: 68px;" onclick="transliterate(document.post.message, this);" />
	<a href="#" onclick="toggle_block('translit_opt'); return false"><span style="color: darkred"><b>?</b></span></a>-->
	<a href="#" onclick="toggle_block('rule_opt'); return false"><input type="button" value="Правила коментариев"></a>
	<!-- ENDIF -->
</div>
...
<!-- IF USER_RUS -->
<div id="rule_opt" class="mrg_4" style="display: none;">
	<table width="100%" cellspacing="0" class="rule_expl borderless bCenter">
	<tr>
		<th><img src="/images/banners/stop.png"/></th>
		<td >
		<b>Запрещается:</b><br/>
		1. Сообщения с ненормативной лексикой. (мат)<br/>
		2. Сообщения не относящееся к теме дискуссии. (оффтоп)<br/>
		3. Сообщения с пропагандой, насилием и межнациональной розни.<br/>
		4. Сообщения с множественным количеством комментариев подряд. (спам)<br/>
		5. Сообщения с чрезмерным многоуровневым цитированием. (оверквотинг)<br/>
		6. Сообщения содержащие только один или несколько смайлов, цифр, символов.<br/>
		7. Сообщения рекламного характера в том числе и рекламирующие другой сайт.<br/>
		8. Сообщения с обсуждением данных правил, а так же действия администрации. <br/>
		9. Сообщения с угрозами в адрес участников форума или администрации.<br/>
		</td>
...
<div style="display:none;" class="translit_expl" id="rules_opt">
	<table cellspacing="0" class="translit_expl">
	<tbody><tr><th><img src="/images/banners/stop.png"/><br/><br/></th>
		<th>
		<b>Запрещается:</b><br/>
		1. Сообщения с ненормативной лексикой. (мат)<br/>
		2. Сообщения не относящееся к теме дискуссии. (оффтоп)<br/>
...
bbcode.addTag("codeThumbnails", "th", null, "T", ctrl);
//bbcode.addTag("codeSkrinshot", "spoiler=\"Скриншоты\"", null, "/spoiler",  ctrl);



bbcode.addTag("codeYouTube", "youtube", "/youtube", "Y", ctrl)
bbcode.addTag("codeSkrinshot", "spoiler=\"Скриншоты\"", "/spoiler", "",  ctrl);

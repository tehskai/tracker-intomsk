...
<tr>
	...
	<!-- ELSE -->
		...
		<!-- IF postrow.POSTER_GENDER --><p class="prov"><em>{L_GENDER}:</em> {postrow.POSTER_GENDER}</p><!-- ENDIF -->
		...
		<div>
			...
			<span id="user_stats_{postrow.POST_ID}" style="display:none"><p><b>Загрузка...</td></p></span>
		</div>
	<!-- ENDIF -->

...
g_l = [];
g_l["MONTHS"] = ["Январь","Февряль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"];
g_l["DAYS_3"] = ["Вс","Пн","Вт","Ср","Чт","Пт","Сб"];
g_l["MONTH_FWD"] = "На месяц вперед";
g_l["MONTH_BCK"] = "На месяц назад";
g_l["YEAR_FWD"] = "На год вперед";
g_l["YEAR_BCK"] = "На год назад";
g_l["CLOSE"] = "Закрыть календарь";
g_l["ERROR_2"] = g_l["ERROR_1"] = "Некорректная дата!";
...
/*
	...
	Thank you!
*/
g_jsDatePickImagePath = "templates/tracker/js/calend/img/";

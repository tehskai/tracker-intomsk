...
$images['icon_user_ban']       = $_main .'user_ban.gif';
$images['icon_mod']            = $_main .'icon_mod.gif';
$images['icon_www']            = $_lang .'icon_www.gif';
$images['icon_skype']            = $_lang .'icon_skype.gif';
...
$images['topic_mod_bin']       = $_main .'topic_bin.gif'; 
...
// Report
$images['icon_report']         = $_main .'icon_report.png';
$images['icon_reported']       = $_main .'icon_reported.png';
...
if (!empty($page_cfg['load_tpl_vars']) AND $vars = array_flip($page_cfg['load_tpl_vars']))
{
	if (isset($vars['post_buttons']))
	{
		$template->assign_vars(array(
			...
			'BAN_USER_IMG'    => ($bb_cfg['text_buttons']) ? $lang['USER_BAN_TXTB']    : '<img src="'. $images['icon_user_ban']     .'" alt="User Ban" title="'. $lang['USER_BAN'] .'" />',

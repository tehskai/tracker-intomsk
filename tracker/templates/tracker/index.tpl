...
<div id="forums_top_links">
	<div class="floatL">
		...
		<a href="#legend-explain" class="menu-root menu-alt1 med">Легенда форумов</a>
	</div>
		...
		<tr>
			...
			<td class="row1 f_titles">
				...
				<p class="subforums">
					<em>{L_SUBFORUMS}:</em>
					<!-- BEGIN sf -->
					<span class="sf_title{c.f.sf.SF_NEW}"><a href="search.php?f={c.f.sf.SF_ID}&amp;new=1&amp;dm=1&amp;s=0&amp;o=1" class="dot-sf"><img src="/templates/{$bb_cfg['tpl_name']}/images/757.png"></a><a href="{FORUM_URL}{c.f.sf.SF_ID}" class="dot-sf">{c.f.sf.SF_NAME}</a></span><span class="sf_separator"></span>
					<!-- END sf -->
				</p>
				<!-- ENDIF -->
...
<!-- IF AD_BLOCK_200 --><div id="ad-100">
<div class="banner_l" style="float:center;">
{AD_BLOCK_200}
</div>
</div><!--/ad-200--><!-- ENDIF / AD_BLOCK_200 -->
		...
		<td class="row1 small last_td">
			<div class="med" style="line-height: 16px">
				...
				<!-- IF SHOW_ONLINE_LIST -->
					...
					<div class="hr1" style="margin: 5px 0 4px;"></div>
					<a href="#online_explain" class="menu-root menu-alt1"><p id="online_time">{L_ONLINE_EXPLAIN}</p></a>
		<style type="text/css">
.menu-a { background: #FFFFFF; border: 1px solid #92A3A4; }
.menu-a a { background: #EFEFEF; padding: 4px 10px 5px; margin: 1px; display: block;}
		</style>
			<div class="menu-sub" id="online_explain">
				<div class="menu-a">
					<a class="med">
					<!---<p id="online_explain">-->
						 <span class="colorAdmin"><b>{L_ONLINE_ADMIN}</b></span> |
						 <span class="colorMod"><b>{L_ONLINE_MOD}</b></span> |
						 <span class="colorVIP"><b>{L_ONLINE_VIP}</b></span> |
						 <span class="colorNews"><b>{L_ONLINE_News}</b></span> |
						 <span class="colorS_G"><b>{L_ONLINE_S_G}</b></span> |
						 <span class="colorRG_G"><b>{L_ONLINE_RG_GAMEMAN}</b></span> |
...
<!--<a href="#legend-explain" class="menu-root menu-alt1"><p id="online_time">Легенда форумов</p></a>-->
			<div class="menu-sub" id="legend-explain">
			<table cellspacing="1" cellpadding="4">
				<tr>
					<td>
					<fieldset id="f_icons_legend">
					<legend>Описание легенды форумов</legend>
					<div class="menu-sub1">
					<table class="bCenter" >
					<tr>

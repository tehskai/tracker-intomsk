...
<tr class="row3 med">
<td class="bold tCenter" colspan="2">Last added, Top torrents, Top users</td>
</tr>
<tr>
<td><h4>Макс. длинна темы</h4></td>
<td><input class="post" type="text" size="25" maxlength="100" name="max_last_title" value="{MAX_LAST_TITLE}" /></td>
</tr>
<tr>
<td><h4>Сколько показывать новые торренты</h4></td>
<td><input class="post" type="text" size="25" maxlength="100" name="t_last_added_num" value="{ADDED_COUNT}" /></td>
</tr>
<tr>
<td><h4>Сколько показывать самые скачиваемые</h4></td>
<td><input class="post" type="text" size="25" maxlength="100" name="t_top_downloaded" value="{DOWNLOADED_COUNT}" /></td>
</tr>
<tr>
<td><h4>Сколько показывать топ сидеров</h4></td>
<td><input class="post" type="text" size="25" maxlength="100" name="t_top_uploaders" value="{UPLOADERS_COUNT}" /></td>
</tr>
<tr>
<td><h4>Сколько показывать топ личеров</h4></td>
<td><input class="post" type="text" size="25" maxlength="100" name="t_top_downloaders" value="{DOWNLOADERS_COUNT}" /></td>
</tr>
<tr class="row3 med">

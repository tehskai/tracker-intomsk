...
$bb_cfg['final_date'] = '2012, 02, 18, 21, 15, 00';
...
$bb_cfg['db']['db1'] = array('localhost', 'tracker', 'root', '', $charset, $pconnect);
...
// Server
$bb_cfg['server_name'] = (!empty($_SERVER['SERVER_NAME'])) ? $_SERVER['SERVER_NAME'] : 'tracker.intomsk.com';         // The domain name from which this board runs
...
$bb_cfg['passkey_key']        = 'ru';              // Passkey key name in GET request
...
$bb_cfg['bt_min_ratio_allow_dl_tor'] = 0.2;          // 0 - disable
$bb_cfg['bt_min_ratio_warning']      = 0.3;          // 0 - disable
$bb_cfg['bt_min_ratio_dl_button']    = 0.2;          // 0 - disable

$tr_cfg = array(
	'autoclean'             => true,
	'off'                   => false,
	'off_reason'            => 'Обновление трекера, 10-15 минут.',
	'numwant'               => 50,
	'update_dlstat'         => true,
	'expire_factor'         => 2.5,
	'compact_mode'          => true,
...
$bb_cfg['dn_icon_path'] = "/images/btn_download.png";
...
$bb_cfg['ad_blocks'] = array(
	'trans' => array( // сквозные банеры
		100 => 'сквозная верх1',
		101 => 'Сквозной верх2',
	),
	'index' => array(
		102 => 'Реклама главная сайдбар',
		103 => 'Футер',
		104 => 'Sidebar1 - only main page',
	),
	'tracker' => array(
		7	=> 'tracker 1',
		8	=> 'tracker 2',
...
$bb_cfg['porno_forums_screenshots_topic_id'] = 0;
$bb_cfg['trash_forum_id'] = 75;                     // (int)    27

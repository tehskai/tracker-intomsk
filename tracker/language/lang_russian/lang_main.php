...
$lang['ONLINE_VIP'] = 'VIP';
$lang['ONLINE_News'] = 'Редакторы НВС';
$lang['ONLINE_S_G'] = 'RG Splash Games';
$lang['ONLINE_RG_REALESERS'] = 'RG Realesers';
$lang['ONLINE_RG_GAMEMAN'] = 'RG Игроманы';
...
$lang['POST_A_NEW_RELEASE'] = 'Создать новый релиз';
...
// Viewonline
//
$lang['REG_USERS_ZERO_ONLINE'] = 'Сейчас на сайте зарегистрированных пользователей: 0 и '; // There ae 5 Registered and
...
// Seed points [START]
$lang['SEED_POINTS'] = 'Очки за сидирование';
$lang['BONUS_TYPE'] = 'Тип бонуса';
$lang['SEED_POINTS_SHORT'] = 'Очки';
$lang['SEED_POINTS_EXCHANGE'] = 'Обменять';
$lang['MY_BONUS'] = 'Мой бонус';
$lang['UPLOAD_TIP'] = 'Если Вы набрали данное количество очков, Вы можете обменять их здесь на количество отданного, количество очков уменьшится, Вы получите прибавку к Вашему аплоаду.';
$lang['INVITE_TIP'] = 'Если Вы набрали данное количество очков, Вы можете обменять их на инвайт (приглашение на регистрацию) и пригласить кого-нибудь на трекер.';
$lang['VIP_TIP'] = 'Если Вы набрали данное количество очков, Вы можете обменять их на VIP статус соответствующего тарифа и получить все его бонусы.';
$lang['POINTS_NOT_ENOUGH'] = "Недостаточно бонусов";
$lang['SUCCESSFULLY_EXCHANGED_UP'] = "Бонус успешно обменян на аплоад. <b>%s</b> бонусов потрачено, вы получили <b>%s</b> гигабайт аплоада.";
$lang['SUCCESSFULLY_EXCHANGED_INVITE'] = "Бонус успешно обменян на %s. <b>%s</b> бонусов потрачено, вы получили <b style=\"color:#0000AA;\">%s %s</b>, <a href=\"/profile.php?mode=bonus&do=invites\">Перейтик списку инвайтов</a>.";
$lang['SUCCESSFULLY_EXCHANGED_VIP'] = "Бонус успешно обменян на <b class=\"colorVIP\">VIP</b> статус. Тариф: <b>%s</b>, Закончится: <b>%s</b>, обменен на <b>%s</b> бонусов";
$lang['RETURN_TO_BONUS'] = "Вернуться к управлению бонусами";
// Seed points [END]

$lang['AGREE'] = 'Я согласен с этими условиями';
$lang['DO_NOT_AGREE'] = 'Я не согласен с этими условиями';


// Ads
$lang['ADS_ADVERT'] = 'Управление рекламой';
$lang['ADS_ADD_STUFF'] = 'Добавление материала';
$lang['ADS_EDIT_STUFF'] = 'Редактирования материала';
$lang['ADS_LIST'] = 'Список';
$lang['ADS_ADD'] = 'Добавить';
$lang['ADS_BANNER'] = 'Список банеров';
$lang['ADS_ID'] = 'ID Блоков';
$lang['ADS_DATE'] = 'Начала показа';
$lang['ADS_ACTIVITY'] = 'Активность';
$lang['ADS_STATUS'] = 'Статус';
$lang['ADS_DESC'] = 'Описание';
$lang['ADS_BLOCK'] = 'Вид блока';
$lang['ADS_RED'] = 'Ред./Уд.';
$lang['ADS_DESC_OP'] = 'Краткое описание';
$lang['ADS_HTML'] = 'Код материала';
$lang['ADS_SHOW'] = 'Показывать дней(только целое число)';
$lang['ADS_DEL_ADD'] = 'Добавить / Удалить редактор';
$lang['ADS_CAL'] = 'Календарь';
...
$lang['DOWNLOAD_ELSE'] = 'Скачаны раз';
...
$lang['STYLE'] = 'по числу благодарностей';
...
$lang['HITS'] ='Панель управления новинками';
$lang['ERR_HITS_LIST'] ='Ошибка при получении списка новинок';
$lang['HIT_EDITED'] ='<font color="#008800"><p><b>Новинка отредактирована</b></p></font><b><a href="hits.php">Вернуться</a></b>';
$lang['HIT_NOT_RELATED_CHARACTERS'] ='<font color=\"#AA0000\"><p><b>Ошибка: Введенные данные не соответствуют требуемым. Обратитесь к администратору</b></p></font><b><a href="hits.php">Вернуться</a></b>';
$lang['HIT_IS_ALREADY'] ='<font color=\"#AA0000\"><p><b>Ошибка: Такая тема уже есть в новинках.</b></p></font><b><a href="hits.php">Вернуться</a></b>';
$lang['HIT_ADDED'] ='<font color="#008800"><p><b>Новинка добавлена</b></p></font><b><a href="hits.php">Вернуться</a></b>';
$lang['HIT_DELETED'] ='<font color="#008800"><p><b>Новинка удалена</b></p></font><b><a href="hits.php">Вернуться</a></b>';
$lang['LAST_20_HITS'] ='Последние 20 новинок';
$lang['ALL_HITS'] = 'Все новинки';
$lang['HIT_NUM'] = '#';
$lang['HIT_TOPIC_ID'] = 'ID топика';
$lang['HIT_DESCR'] = 'Название(описание)';
$lang['HIT_ID'] = 'ID';
$lang['HIT_EDIT'] = 'Редактировать';
$lang['HIT_DEL'] = 'Удалить';
$lang['EDIT_HITS'] = 'Редактировать новинку';
$lang['EDIT_HIT_TOPIC_ID'] = 'Введите ID топика';
$lang['EDIT_HIT_DESCR'] = 'Название(описание)';
$lang['EDIT_HIT_SAVE'] = 'Редактировать новинку';
$lang['ADD_HITS'] = 'Добавить новинку';
$lang['ADD_HIT_SAVE'] = 'Сохранить';
...
$lang['USER_BAN'] = 'Забанить автора поста';
$lang['USER_NAN_TXTB'] = '[Бан!]';

// Парковка аккаунта
$lang['PARK_CONTROL'] ='Парковка аккаунта';
$lang['PARK_WARNING'] ='Припарковав аккаунт Вы не сможете скачивать!';
$lang['PARK_PROFILE_STATUS'] ='Припаркован';
$lang['PARK_PROFILE_STATUS_WHOTE'] ='Что такое &quot;Парковка Аккаунта&quot;?';

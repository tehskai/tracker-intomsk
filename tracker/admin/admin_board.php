...
switch($mode)
{
	case 'config_mods':
	    $template->assign_vars(array(
		    ...
		    'MAX_LAST_TITLE' => $new['max_last_title'],
		    'ADDED_COUNT' => $new['t_last_added_num'],
		    'DOWNLOADED_COUNT' => $new['t_top_downloaded'],
		    'UPLOADERS_COUNT' => $new['t_top_uploaders'],
		    'DOWNLOADERS_COUNT' => $new['t_top_downloaders'],
	    ));
